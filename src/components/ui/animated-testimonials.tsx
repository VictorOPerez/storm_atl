            ...
            <div className="relative grid grid-cols-1 gap-5 md:gap-20 md:grid-cols-2">
                <div className=" relative flex md:block items-center gap-4">
                    ...
                    <motion.div
                        ...
                        transition={{
                            duration: 0.2,
                            ease: "easeInOut",
                        }} className=" block md:hidden md:absolute md:bottom-4 md:left-1/2 md:-translate-x-1/2 text-right"
                ...
                <div className="flex flex-col justify-between py-4">
                    ...
                    >
                        ...
                        <motion.p className="md:mt-8 text-lg text-gray-500 h-[150px]  md:h-[220px] dark:text-neutral-300">
