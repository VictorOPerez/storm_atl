...
export const metadata: Metadata = {
    title: "Contact | Atlanta Towing",
    description:
        "Contact us 24/7. Emergency calls, WhatsApp, email, and a form with your location.",
        ...
        <main className="min-h-[100dvh] bg-[#0B0B10] text-white antialiased">
                ...
                <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 pt-16 pb-12 lg:pt-24 lg:pb-16">
                    <div className="max-w-3xl">
                        ...
                        <p className="mt-3 text-lg text-slate-300">
                            Tell us where you are and what you need, and we’ll dispatch the closest truck.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-10 grid gap-8 lg:grid-cols-5">
                ...
                <div className="lg:col-span-2 grid gap-6">
                    <NeonCard>
                        <h3 className="text-lg font-bold">Emergencies</h3>
                        ...
                        <ul className="mt-4 grid gap-2 text-sm text-slate-300">
                            <li className="flex items-center gap-2"><Dot /> Accurate real-time ETA</li>
                            <li className="flex items-center gap-2"><Dot /> Certified operators</li>
                            <li className="flex items-center gap-2"><Dot /> Coverage in Atlanta and surrounding areas</li>
                        </ul>
                    </NeonCard>
                    ...
                    {/* Static embedded map (no client deps) */}
                    <NeonCard>
                        <h3 className="text-lg font-bold">Coverage</h3>
                        <p className="mt-1 text-slate-300 text-sm">
                            Outside our area? Message us anyway and we’ll check availability.
                        </p>
                        <div className="mt-3 overflow-hidden rounded-xl ring-1 ring-white/10">
                            <iframe
                                ...
                                // You can switch to your own static map (MapTiler/Mapbox) for a custom style
    ...
    return (
        <div className={`relative ${className}`}>
            ...
            <div className="relative rounded-2xl border border-white/10 bg-white/[0.04] p-5 md:p-6 backdrop-blur-sm">
                {/* Subtle inner border with gradient */}
                <div
                    aria-hidden
...
/* Background with “lights” and speed lines */
